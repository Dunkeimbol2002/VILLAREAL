  ...
  function A(a, b) {
    w === s &&
      (w =
        -1 ===
        y
          .serializeToString(i.parseXML(B["xl/worksheets/sheet1.xml"]))
          .indexOf("xmlns:r"));
      ...
      if (i.isPlainObject(c)) {
        ...
        if (w) {
          ...
          for (g = b.attributes.length - 1; 0 <= g; g--) {
            ...
            -1 !== e.indexOf(":") &&
              (n.push({ name: e, value: h }), b.removeAttribute(e));
          }
          g = 0;
  ...
  o.ext.buttons.excelHtml5 = {
    ...
    action: function (a, b, d, c) {
          ...
          for (var b = 0, d = a.length; b < d; b++) {
            ...
            j ||
              ...
              (a[b].match &&
                ...
                : ((k = !k.replace
                    ? k
                    : k.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "")),
                  (j = q(e, "c", {
      ...
      var k = function (a, b) {
          ...
          c[0].appendChild(
            q(e, "mergeCell", { attr: { ref: "A" + a + ":" + z(b) + a } })
          );
      ...
      for (o = d.header.length; k < o; k++)
        r.appendChild(
          q(e, "col", {
            attr: { min: k + 1, max: k + 1, width: K(d, k), customWidth: 1 },
          })
        );
